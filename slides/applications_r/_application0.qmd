...
4. Créer un script `get_data.R` en copiant le contenu de [ce fichier](https://raw.githubusercontent.com/InseeFrLab/formation-bonnes-pratiques-exo-correction/refs/heads/main/get_data.R), puis l'exécuter
5. Créer le script `script.R` dans votre dépôt en copiant le contenu de [ce fichier](https://github.com/InseeFrLab/formation-bonnes-pratiques-exo-correction/blob/main/script.R). __Ne l'exécutez pas, c'est l'objet de l'exercice suivant__.
