...
* *Commit/push* le fichier `rapport.qmd`. Attention aux nombreux fichiers produits par le rendering ! Utiliser le `.gitignore` pour ne pas risquer de *commit* les mauvais fichiers par inadvertance
