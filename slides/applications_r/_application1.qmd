## Application 1 {.smaller .nonincremental}
...
* Redémarrer votre session avec `Session` > `New Session` (ou <kbd>Ctrl</kbd>+<kbd>Maj</kbd>+<kbd>F10</kbd>) et refaire tourner le code de A à Z. Avez-vous une erreur ?
