...
_❓️ Imaginons que les utilisateurs voudraient aussi se restreindre à certains types de ménages en fonction de caractéristiques: que faudrait-il faire ? Quelle est la limite ?_


## Application 3 (partie 4) {.smaller}

:::{.callout-tip .nonincremental collapse="true" icon=false}
# Partie 4: Généralisation des tests de performance (optionnel)
...
:::{.callout-tip .nonincremental collapse="true" icon=false}
# Partie 5: mise à jour de la chaîne de production

* Lire les données à partir du morceau de code proposé
* Changer la partie modélisation pour ne pas faire tourner celle-ci sur un gros modèle (proposition ci-dessous)
...
<summary>
Changement proposé pour la partie modélisation
</summary>
