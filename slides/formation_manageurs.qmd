...
<h4>Le cas d'usage classique à l'Insee</h4>
...
- Changement de paradigme : [**le code _self_ doit être maintenu**]{.orange}
...
- anticiper les montées de version des logiciels :  on peut envisager un protocole pour cela 
...
# Partie 4: Collaboration et ouverture
