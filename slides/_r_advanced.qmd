...
- Pour la mise à disposition de données : [**Parquet**]{.orange}
  - Format [**interopérable**]{.blue2}
  - [**Méta-données**]{.blue2} livrées avec les données
  - Performances en [**stockage**]{.blue2} et en [**lecture**]{.blue2}

- Pour la documentation / publication : [**quarto**]{.orange}
  - Intègre [**code**]{.blue2} et [**texte**]{.blue2} -> [**reproductibilité**]{.blue2}
  - Publication [**multi-formats**]{.blue2} (`pdf`, `odt`, `html`)
  - Mise à jour automatique avec l'[**intégration continue**]{.blue2}
...
- [**En pratique**]{.orange} : dans le code ou avec [{targets}](https://books.ropensci.org/targets/)
...
- [**En pratique**]{.orange} : dans le code ou avec [pointblank](https://rstudio.github.io/pointblank/)
