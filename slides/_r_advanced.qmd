...
- [**Self de production**]{.orange} : processus déployés sur une [**infra "self"**]{.blue2} contribuant à la [**production statistique**]{.blue2}
...
On dispose finalement d'une chaîne **orchestrée de bout en bout, robuste et bien documentée**. Pour cela, on va utiliser les outils de l'**intégration continue** proposés par `GitHub` / `GitLab`.
