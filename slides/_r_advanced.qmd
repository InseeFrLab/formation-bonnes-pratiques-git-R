...
- [**Production statistique**]{.orange} : chiffres, données, analyses produits par l'Insee

- [**Production informatique**]{.orange} : processus déployés par la DSI sur des [**infrastructures avec "garantie de service"**]{.blue2}

- [**Self de production**]{.orange} : processus déployés sur une [**infra "self"**]{.blue2} (AUS, LS3) contribuant à la production statistique
...
## Les trois commandemements d'Hadley Wickham
...
- Organiser le [**travail collaboratif**]{.orange}
  ...
  - [**Ecosystème Git**]{.blue2} -> outils qui facilitent

- Traiter le code comme un [**élément méthodologique**]{.orange}
  - [**Revue de code**]{.blue2}
  - Programmation en [**binôme**]{.blue2}
...
- Une tâche de [**production**]{.orange} est [**répétée**]{.orange} dans le temps
  - Opportunité d'[**automatiser**]{.blue2} les traitements

- [**Problème**]{.orange} : le monde "autour du code" évolue
  - Nécessité de [**gérer les évolutions**]{.blue2}
...
- On limite les risques en [**spécifiant**]{.orange} et en [**distribuant l'environnement**]{.orange}
  - [**Fixer**]{.blue2} les versions des packages utilisés : `renv`
  - [**Versionner**]{.blue2} sa chaîne de production : tags `Git`

## "Not just once"

- L'[**environnement**]{.orange} change (OS, librairies système, version de R...)
