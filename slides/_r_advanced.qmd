...
- [**Production informatique**]{.orange} : processus maintenus en condition opérationnelle par la DSI sur des [**infrastructures avec "garantie de service"**]{.blue2}

- [**Self de production**]{.orange} : processus maintenus en condition opérationnelle par le métier sur une [**infra "self"**]{.blue2} contribuant à la [**production statistique**]{.blue2}
