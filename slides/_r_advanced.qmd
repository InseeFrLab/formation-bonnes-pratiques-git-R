...
Une structuration de projet plus viable ![](img/environment.png){width="10%" fig-align="right"}
...
- Qu'est-ce qui change 🤔 ? [**Techniquement**]{.orange}, quasi tout !
...
- Monde conteneurisé -> non-persistence -> Git non négociable
...
- Le [**débogage**]{.orange} devient plus difficile
  - Nécessité du [***logging***]{.blue2}
  
- Outil : [logger](https://cran.r-project.org/web/packages/logger/vignettes/Intro.html)
