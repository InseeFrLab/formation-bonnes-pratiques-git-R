...
## Les trois commandements d'Hadley Wickham
...
- Spécifier les [**attendus**]{.orange}
  - [**Tests unitaires**]{.blue2} : vérifie le bon [**comportement**]{.blue2} du code
  - [**Validation de données**]{.blue2} : vérifie l'[**intégrité**]{.blue2} et la [**qualité**]{.blue2} des données
...
- La [**conteneurisation**]{.orange} permet de [**fixer l'environnement**]{.orange}
  - Favorise la [**reproductibilité**]{.blue2} et la [**portabilité**]{.blue2}
