...
2. Modifier `main.R` pour tenir compte de la modularisation ([contenu](https://github.com/InseeFrLab/formation-bonnes-pratiques-git-R/blob/main/R/checkpoints/application5_part2/main_sspcloud.R))
