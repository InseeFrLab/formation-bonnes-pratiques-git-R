...
::: {.nonincremental}
* Version courte de la formation aux bonnes pratiques avec `R` et `Git` ([page d'accueil](https://inseefrlab.github.io/formation-bonnes-pratiques-git-R/))


![](https://inseefrlab.github.io/formation-bonnes-pratiques-git-R/cards/version-light/cheetah.png){fig-align="center" height=400}
