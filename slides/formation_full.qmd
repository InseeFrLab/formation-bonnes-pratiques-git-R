...
::: {.nonincremental}
* Version longue de la formation aux bonnes pratiques avec `R` et `Git` ([retour à la page d'accueil](https://inseefrlab.github.io/formation-bonnes-pratiques-git-R/))
